...
if __name__ == '__main__':
    ...
    write_path2 = './eval_final2_12222023_5pm_hist.json'
    ...
    evaluate_pipeline(recc_model, recc_tokenizer, resp_model, resp_tokenizer, resp_model, resp_tokenizer, write_path, write_path2, 10, True)